    ...
    return (
        <div className="drawer lg:drawer-open bg-gray-200 w-11/12 mx-auto">
            ...
            <div className="drawer-content">
                ...
                {/* Page content here and outlate here */}
                <Outlet></Outlet>
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        {/* Main home click logo icon then go home page; */}
                        <li>
                            <Link to={'/'}>
                                <img src={logo} alt="" />
                            </Link>
                        ...
                        {/* List item */}
                        <li>
                            <Link to={'/dashboard'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right">
                        ...
                        {/* MyPercels */}
                        <li>
                            <Link to={'/dashboard/mypercels'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" >
                        ...
                        {/* Role admin then show approved rider and user management page */}
                        {
                            role === 'admin' && <>
                                ...
                                {/* assign-riders */}
                                <li>
                                    <Link to={'/dashboard/assignRiders'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" >
